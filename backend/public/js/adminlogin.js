        ...
        button.addEventListener("click", function () {
            ...
            if (passwordInput) {
                ...
                this.innerHTML = isPassword
                    ...
                    : '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-slash" viewBox="0 0 16 16">...</svg>';
            }
        });
    });
}
...
function adminLoginValidation() {
    document.getElementById("adminLoginForm").addEventListener("submit", async function (event) {
        ...
        try {
            ...
            var alertErrorContainer = document.getElementById('adminAlert');
            if (alertErrorContainer) {
                alertErrorContainer.innerHTML = `
                    <div class="alert alert-danger d-flex align-items-center alert-container text-dark" role="alert">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-exclamation-triangle-fill flex-shrink-0 me-2 text-light" viewBox="0 0 16 16">
